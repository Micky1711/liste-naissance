...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
<!-- Start of preheader -->
<table width="100%" bgcolor="#16a085" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
   <tbody>
      <tr>
         <td>
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td align="center">
                                    ...
                                    {{ HTML::image('assets/uimages/emails/header.jpg', 'Liste de naissance', array( 'width' => 600, 'height' => 150, 'border' => 0, 'style' => 'display:block; border:none; outline:none; text-decoration:none', 'class' => 'logo' )) }}
                                    </a>
                                 </td>
                              </tr>
                           </tbody>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #ffffff">
                                    Vous avez reçu cet email car vous êtes inscris sur le site de la liste de naissance d'Anne et Mickaël<br>
                                    Conformément à la loi numérique, vous pouvez à tout moment supprimer votre compte (contactez un administrateur))
                                 </td>
                              </tr>
                              <!-- Spacing -->
                              <tr>
